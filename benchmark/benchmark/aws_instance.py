...
class InstanceManager:
    INSTANCE_NAME = 'ambulance-node'
    SECURITY_GROUP_NAME = 'ambulance-security-group'
        ...
        try:
            ...
            for client in progress:
                client.run_instances(
                    ...
                    MinCount=instances,
                    LaunchTemplate={
                        'LaunchTemplateName': self.settings.templates[i],
                        'Version': self.settings.template_versions[i],
                    },
                )
                i += 1
